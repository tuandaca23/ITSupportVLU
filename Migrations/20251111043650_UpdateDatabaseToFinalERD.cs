...
{
    /// <inheritdoc />
    public partial class UpdateDatabaseToFinalERD : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CannedResponse", x => x.ResponseId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InternalNote", x => x.NoteId);
                    table.ForeignKey(
                        name: "FK_InternalNote_Ticket_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Ticket",
                        principalColumn: "TicketId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InternalNote_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TicketAssignment_User_TechnicianId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TicketHistory_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketReplie", x => x.ReplyId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CannedResponse_CategoryId",
                table: "CannedResponse",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_InternalNote_TicketId",
                table: "InternalNote",
                column: "TicketId");

            migrationBuilder.CreateIndex(
                name: "IX_InternalNote_UserId",
                table: "InternalNote",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketAttachment_ReplyId",
